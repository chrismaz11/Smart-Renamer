...
selectFolderBtn.addEventListener('click', async () => {
    try {
        ...
        // Update loading text for the next phase
        setLoading(selectFolderBtn, true, 'Reading...')
...
renameFilesBtn.addEventListener('click', async () => {
    if (selectedFolderPath) {
        try {
            ...
            previewPanel.innerHTML = '<div class="text-red-500 italic">Error renaming files. See console for details.</div>'
        } finally {
